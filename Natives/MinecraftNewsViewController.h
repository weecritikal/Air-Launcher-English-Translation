...
//  Tapping "View details" opens the article inline in an SFSafariViewController (without leaving the app)
//
...
@interface MinecraftNewsViewController : UIViewController
